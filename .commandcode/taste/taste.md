...
# language
- Use Bahasa Indonesia for all conversation and responses. Confidence: 0.85

# tools
- Prefer using Gemini Canvas for building web-based tools and applications. Confidence: 0.75

# design
- Prefers polished, reading-optimized typography for long-form technical writing content (proper measure ~70ch, generous line-height, carefully sized headings, good spacing rhythm). Confidence: 0.9

# ux
- Prefers displaying reading time on blog/article posts for better content scannability. Confidence: 0.75
- Prefers dynamic content fetching from collections over hardcoded HTML for blog/article previews on homepage. Confidence: 0.7
...
# design
- Prefers visually distinguishing between real code blocks (with language tags like ```php, ```sql) and plain commit/log blocks (code fences without language tags) — real code gets more prominent styling, plain blocks get subdued treatment. Confidence: 0.8
