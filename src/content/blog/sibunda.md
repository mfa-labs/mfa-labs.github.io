---
title: SIBUNDA — Aplikasi Monitoring Gizi & Pencegahan Stunting
description: Aplikasi mobile Flutter + REST API untuk pemantauan gizi dan pencegahan stunting anak balita bersama Fakultas Keperawatan USK
pubDate: 2026-09-01
tags: ['Flutter', 'Dart', 'REST API', 'Node.js', 'Stunting', 'Healthcare', 'Mobile']
---

**Proyek**: Aplikasi mobile Android + REST API untuk pemantauan gizi dan pencegahan stunting pada anak batita/balita

**Peran**: Fullstack Developer (Flutter & Backend)

**Periode**: Proyek institusi/penelitian bersama Fakultas Keperawatan, Universitas Syiah Kuala (USK)
