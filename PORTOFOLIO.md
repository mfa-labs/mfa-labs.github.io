...
**Komit**: ~28 non-merge | **File terkait**: 2 controller CRM, WorkerNotif.php, ModelUtama.php (2.488 baris) | **Periode**: Mei 2021 — Juli 2026
...
**Legacy Cron (WorkerNotif.php, 2021–2025)**
...
- **Laporan Dinkes** — laporan untuk Dinas Kesehatan (SKP dokter, laporan GrupA)
...
- **Combined RM** — rekam medis gabungan untuk klinik bersama (GrupA, GrupD, GrupC, GrupE)
...
- **Shared clinic groups**: multi-klinik berbagi data pasien (GrupA, GrupB, GrupC, GrupD, GrupE)
...
- **Session & cache** — Redis configuration (unix socket), session encryption (`REDACTED` key)
...
| **2025** | 61 | GrupE klinik bersama, laporan dinkes, ICD-9 checkout, bug fixing, dokumentasi |
